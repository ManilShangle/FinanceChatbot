...
for i in range(10):
    ...
    total += total_time
    r = reasoner(paths)
    query = 'What stock should I buy if I\'m low income, and I\'m interested in the tech sector and want moderate risk.'
    ...
    if query_predicates == 'irrelevant':
        reply = 'Sorry, I am only a finance professional helping with recommending stocks, could you please repeat what you are looking for?'
